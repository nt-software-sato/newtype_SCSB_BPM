...
public partial class FERPCallBPM : System.Web.UI.Page
{
    ...
    string StarFlow(string connString, string RequisitionID, string RowData, string Identify, string ApplicantID, string ApplicantDept, string OrgApplicantID, string CounterSignID, string CounterSignName)
    {
      ...
      //M_row["CHAGEUSEDEPARTMENTID"] = DetailDt.Rows[0]["CHAGEUSEDEPARTMENTID"].ToString(); //20200620 issue
      //M_row["CHAGEUSEDEPARTMENTNAME"] = DetailDt.Rows[0]["CHAGEUSEDEPARTMENTNAME"].ToString();  //20200620 issue
        M_row["CHAGEUSEDEPARTMENTID"] = DetailDt.Rows[0]["TRANSFERINMANAGEMENTDEPARTMENTID"].ToString();
        M_row["CHAGEUSEDEPARTMENTNAME"] = DetailDt.Rows[0]["TRANSFERINMANAGEMENTDEPARTMENTNAME"].ToString();
